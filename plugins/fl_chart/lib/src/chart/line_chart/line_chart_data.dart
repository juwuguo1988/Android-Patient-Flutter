...
typedef GetTextStyleCallback = TextStyle Function(FlSpot spot);

TextStyle _defaultGetTextStyle (FlSpot spot) {
  return TextStyle(color: Colors.black87, fontWeight: FontWeight.bold);
}
...
class FlDotData with EquatableMixin {
  ...
  final bool showText;
  final GetTextStyleCallback getTextStyle;
  ...
  FlDotData({
    ...
    bool showText,
    GetTextStyleCallback getTextStyle,
    Offset textOffset,
  })  : show = show ?? true,
        dotSize = dotSize ?? 4.0,
        ...
        getTextStyle = getTextStyle ?? _defaultGetTextStyle,
//        TextStyle(color: Colors.black87, fontWeight: FontWeight.bold)
        textOffset = textOffset ?? const Offset(0, 0);
