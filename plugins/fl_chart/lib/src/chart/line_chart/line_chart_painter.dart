...
//          final TextStyle _defaultStyle = TextStyle(color: Colors.red, fontSize: 12, fontWeight: FontWeight.bold);
          final Offset _defaultOffset = Offset(x - 8, y - 20);
          // 绘制spot点y轴数值
//          print("barData.dotData.getTextStyle ${barData.dotData.getTextStyle(spot)}");
  ...
  void _drawTouchTooltip(Canvas canvas, Size viewSize, LineTouchTooltipData tooltipData,
    ...
    if (tooltipItems.length != showingTooltipSpots.showingSpots.length) {
      throw Exception('tooltipItems and touchedSpots size should be same length');
    }
